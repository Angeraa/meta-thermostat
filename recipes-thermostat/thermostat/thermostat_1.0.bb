...
DEPENDS += " mosquitto paho-mqtt-c paho-mqtt-cpp libgpiod boost lvgl libdrm libinput"
RDEPENDS:${PN} += " mosquitto paho-mqtt-c paho-mqtt-cpp libgpiod boost lvgl libdrm mesa libinput"
